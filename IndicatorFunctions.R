...
# Associating indicators with transformation from observations
    f_fun <- switch(Indicator,
                    ...
                    DINwinter    = Aggregate_year,
                    DINwinterEQR = AggregateEQR_year,
                    DIPwinter    = Aggregate_year,
                    DIPwinterEQR = AggregateEQR_year,
